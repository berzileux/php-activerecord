...
class ActiveRecordFindTest extends DatabaseTest
{
	...
	{
	    //Failed asserting that exception of type "ActiveRecord\DatabaseException" matches expected exception "ActiveRecord\RecordNotFound".
	    $this->expectException(ActiveRecord\DatabaseException::class);
		Author::first('name = 123123123');
	}

	public function test_find_nothing_with_sql_in_string_2()
	{
	    $data = Author::first(array('name' => '123123123'));
	    $this->assertNull($data,"expects return to be null");
	}
	...
	{
	    $this->expectException(ActiveRecord\DatabaseException::class);
		Author::find('first', array('from' => 'wrong_authors_table'));
	}
